...
const Profile = () => {
  const { userData, setUserData, token, loadingUserData } = useContext(AppContext);
        ...
        <div className="flex justify-center">
          {isEdit ? (
            <button
              ...
              className="bg-blue-500 hover:bg-blue-600 text-white px-5 py-2 rounded-md shadow-md transition-transform hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center cursor-pointer"
            >
              {loadingUpdate ? (
                <>
            ...
            <button
              ...
              className="border border-blue-500 text-blue-600 px-5 py-2 rounded-md shadow-sm hover:bg-blue-100 transition-transform hover:scale-105 cursor-pointer"
            >
              EDIT
            </button>
          )}
